...
add('pc01.manual.nonpersonal-not-cleared',manual?.clearOnEndWork===false&&match('ghrab-manual-progress-ludus-1.16.25',manual.patterns||[])&&match('ghrab-manual-theme',manual.patterns||[]),JSON.stringify(manual||{}));
