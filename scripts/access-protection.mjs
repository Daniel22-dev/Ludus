...
async function ensurePrivacyRuntime(){
  ...
  await new Promise((resolve,reject)=>{
    const node=document.createElement('script');node.src=PRIVACY_URL;node.dataset.ludusPrivacyRuntime='1.16.23';node.dataset.ludusPrivacyScope='builder';node.async=false;
