...
- PWA cache zvýšena na `ludus-pwa-v1.14.5`.
...
Verze 1.14.5 obsahuje přímý Studio Bridge v1 a ruční import `ghrab-material-v1` / `LUDUS_CONTENT v2`. Podporované úlohy převádí na stanice a může připravit hratelný engine, třídní soutěž a lesson pack bez dalšího AI volání.
