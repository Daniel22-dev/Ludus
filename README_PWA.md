...
- `public/sw.js` — service worker s cache `ghrab-ludus-v1.16.27`.
...
Při změně PWA assetů je nutné zvýšit jméno cache v `public/sw.js` a verzi v dokumentaci. Aktuální cache: `ghrab-ludus-v1.16.27`.
