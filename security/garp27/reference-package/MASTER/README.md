...
The full source package records PACKAGE_SELFTEST 19/19 and CONTRACT_TEST 25/25. The application
copy here consumes the reference validator and contract tests; neither result is an APP_BEHAVIOR_TEST
or LIVE_TEST for a deployed application.
